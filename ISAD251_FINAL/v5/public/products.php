       ...
       <?php
         ...
         if($Players != NULL)
         {
           ...
           foreach ($Players as $player) 
            ...
            echo '<li class="li" ">';
            echo '   <img class="img" src="'.$player[5].'" alt="'.$player[1].'" title="'.$player[1].'"><img>';
            echo '    <h2>'.$player[1].'</h2>';
            echo '    <div class="body"><p>'.$player[2].'</p></div>';
            echo '    <div title="add to basket" class="btn" id="'.$player[0].'" onclick="addtobasket(this.id)">'.$buttontext.'</div>';
            echo '</li>';
            } 
